...
## Opening
Raise your hand if you've built something with AI that worked.

And who here then tried to keep building on it and had things start breaking?
...
And over time, the whole thing starts to drift.
...
But the moment you're building a system that's more than a one-off, you have to start directing it.
...
For launchable products, you must ask the AI how it should work.
...
And once you do that, now you have something to keep consistent.

## Slide 8
Even if you plan the system, there's another problem.

As the context grows, the AI loses focus.

It stops prioritizing the important ideas.

And starts making decisions that are locally correct, but globally inconsistent.
...
If you're building something simple, just ask AI to build it.

If it's more structured, write a better spec.

If it's a real prototype, plan the system.

But if you're building something long-term, this is where everything changes.
...
This is the difference between something that works once and something you can actually build into a product.

## Slide 10
So now, instead of just prompting AI, you can actually build something that holds up.
